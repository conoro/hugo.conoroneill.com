+++
Categories = ["Reviews"]
Description = "An odd mis-step after the brilliant Prodigio Pro."
Tags = []
draft = false
date = "2025-12-31T11:00:32+00:00"
title = "La Sportiva Prodigio Max is a big disappointment - Running Shoe Review"
slug = "la-sportiva-prodigio-max-review"
+++

As I have only done 30km in the La Sportiva Prodigio Max so far, you can take this review with a grain of salt. You can read my full review of the [La Sportiva Prodigio Pro here](https://conoroneill.com/2025/07/28/la-sportiva-prodigio-pro-review/), which I absolutely loved. So when the Max was announced I immediately pounced. I was imagining something like the Pro but for massive distances. Possible a wider base and toe-box with a more cushioned relaxed ride.

![La Sportiva Prodigio Max](/images/2025/12/prodigio_max_01.jpg)
...
![La Sportiva Prodigio Max](/images/2025/12/prodigio_max_02.jpg)
...
<script type="application/ld+json">{
  ...
  "@type": "Product",
  "name": "La Sportiva Prodigio Max",
  "image": "https://conoroneill.com/images/2025/12/prodigio-max-01.jpg",
  "brand": "La Sportiva",
  "aggregateRating": {
  ...
  "review": [
    {
      "@context": "http://schema.org/",
      "@type": "Review",
      "name": "A disappointing follow-up to the Prodigio Pro",
      "reviewBody": "The La Sportiva Prodigio Max was a letdown after the excellent Prodigio Pro. While I hoped for a more cushioned, stable shoe for long distances, the Max felt unstable on rough terrain and suffered from poor heel lock, making it difficult to run confidently. It performed better on easy, groomed trails, but is not suitable for ultras or technical routes. I recommend La Sportiva revisit the Pro's design for future versions.",
      "reviewRating": {
        "@type": "Rating",
        "ratingValue": 3,
        "bestRating": "3",
